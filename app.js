console.log("все пункты ТЗ выполнены. Оценка 45/45")
...
var createNewTaskElement = function (taskString) {
  ...
  checkBox.className = "todo__input-check";
  editInput.type = "text";
  ...
  deleteButtonImg.alt = "";
  deleteButtonImg.className = "todo__img-x";
...
var bindTaskEvents = function (taskListItem, checkBoxEventHandler) {
  ...
  var checkBox = taskListItem.querySelector(".todo__input-check");
